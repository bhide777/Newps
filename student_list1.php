...
<br>
        ...
        <br>
      <table>
      <form class="modal-content animate"  method="POST" action="vvvv.php">
      <thead>
        <tr>
          <th>USN</th>
          <th>Student name </th>
...
// for($sti=1;$sti!=0;$sti++){
//   if(isset($_POST[$sti])){
//     $sel_st1 = "SELECT usn FROM student WHERE sid=$sti";
//     $res_st1 = mysqli_query($mysqli,$sel_st1);
//     if(mysqli_num_rows($res_st1)>0){
//       while($row=$res_st1->fetch_assoc()){
//           $_SESSION['s_usn'] = $row['sid'];
//           header("location: academic_record.php");
//       }
