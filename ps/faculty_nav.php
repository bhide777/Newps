...
<script>swal("Good job!", "You Logged in!", "success");</script>
    <div id="navbar">
        ...
        <div class="main1">BMS College Of Engineering</div>
            <div class="mainadmin" style="margin-right: 114px;">Welcome <?php session_start(); echo $_SESSION['fname']; ?> </div>
        
            <div class="nav" style="margin-top: -15px;">
                <div class="anav" style="margin-top: 20px;">  <a href="faculty_student_view.php">Students</a></div>
