<?php
    ...
    // $mysqli = mysqli_connect('localhost', 'root', '', 'proctor_system');

    $usn=$_SESSION['s_usn'];
    // echo $usn;
    $sql = "SELECT usn,email,studentname FROM student WHERE usn='$usn'";
...
if(isset($_GET['r'])){
  ...
  if (isset($_POST['submit'])) {
    ...
    foreach($records as $r){
        ...
        $sem = mysqli_real_escape_string($mysqli, $r['sem']);
        $ayr = mysqli_real_escape_string($mysqli, $r['ayr']);
        $cti = mysqli_real_escape_string($mysqli, $r['cti']);
        $ccd = mysqli_real_escape_string($mysqli, $r['ccd']);
        $atd = mysqli_real_escape_string($mysqli, $r['atd']);
        $cre = mysqli_real_escape_string($mysqli, $r['cre']);
        $cie = mysqli_real_escape_string($mysqli, $r['cie']);
        $see = mysqli_real_escape_string($mysqli, $r['see']);
    ...
    <section class="hero is-white is-fullheight">
        <div class="hero-body">
          <div class="container"> 
                    ...
                    <a class="button" href="student.php">
              <span class="icon">
                <i class="fas fa-arrow-left"></i>
              </span>
              <span>Goback</span>
