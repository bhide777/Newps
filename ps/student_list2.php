...
?>
<br>
<p style="text-align:center;font-size:40px">Second Year Students</p><br>
      <table>
      <form class="modal-content animate" action="vvv1.php" method="post">
      <thead>
        <tr>
          <th>USN</th>
          <th>Student name </th>
      ...
      <tbody>
          <?php
          $sel_st = "SELECT sid,usn,studentname,email,fid FROM student WHERE syear=2";
